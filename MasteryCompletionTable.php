<?php
    ...
    $upto = $lcCount[0] + ($dCount[0]) + ($daCount[0]);
                            ...
                            echo "<tr>";
                                ...
                                for($j = 0; $j < sizeof($catIDs); $j++) {
                                    if(isset($masteryTotals[$names[$i]][$j])) {
                                        ...
                                        if(($j < $upto && $masteryTotals[$names[$i]][$j] == 0) || ($j >= $upto && ($masteryTotals[$names[$i]][$j] == 0))) {
                                            echo "<td class=\"red\">";
                                        }

                                        else if($masteryTotals[$names[$i]][$j] == 1 && ($j < $upto)) {
                                            echo "<td class=\"yellow\">";
                                        }

                                        else if (($j < $upto && $masteryTotals[$names[$i]][$j] >= 2) || ($j >= $upto && ($masteryTotals[$names[$i]][$j] >= 1))){
                                            echo "<td class=\"green\">";
                                        }
                                        else {
                                            echo "<td>";
